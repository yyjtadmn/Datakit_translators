Creo to JT Translator - v1.0.0 Beta Release version
...
The translator package includes v1.0.0 beta of the Creo JT translator.
This supports translation of Creo (*.asm, *.prt) files.

The translator is invoked through a Linux console.
You can provide a single Creo file that may be a piece part or an assembly as input and get one JT file as output.
...
SECTION 2 - Capabilities Supported
    ...
    - The Creo JT translator supports following capabilities
...
SECTION 4 - Installation Instructions and Usage
	...
	- Set following environment variables -
			CREO_JT_INSTALL=.../jt_creo_d                ---> This is the directory containing translator binaries.
	...
	- Sample docker file 
			...
			WORKDIR /app
			COPY jt_creo_d/     /app/jt_creo_d
			COPY run_creotojt /app

			ENV CREO_JT_INSTALL=/app/jt_creo_d
			ENV LANG=en_US.utf8
		
	- Run script "run_creotojt" with part or assembly file as input.
	    	run_creotojt <xxx.prt>
